...
if Park.count == 0
  ...
  Park.create(category_id: rand(7) + 1, feature_id: rand(23) + 1, address_id: 3, user_id: 1, name: "Footscray Park", cheese: "Bocconcini", wine: "Merlot", latitude: -37.7930638, longitude: 144.9049412)
  puts "Created parks"
end
