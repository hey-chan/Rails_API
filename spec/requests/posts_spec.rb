...
RSpec.describe "Posts", type: :request do
  ...
  describe "POST /posts" do
    before(:all) do
      ...
      @park = create(:park, name: "Test park", address_id: @address.id, category_id: @category.id, feature_id: @feature.id, user_id: @user.id, latitude: 123.123, longitude: 123.123)
    end
